...
R also has a large number of add-on [packages][cranID2] that extend the basic function, and we'll be using several of these for machine learning. Today, we'll just use a couple of these for data manipulation and plotting. 
...
[cranid2]: https://cran.r-project.org/web/packages/
