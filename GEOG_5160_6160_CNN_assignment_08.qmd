...
-   A notebook (Python) or Quarto document that provides your code and a brief description of your model. This code should be capable of being run.
-   An accuracy score for your final model based on an evaluate of a test set of images
-   Students enrolled in 6160 should also integrate one of the methods for extending the basic CNN introduced in lab 9 (augmentation, transfer learning), and report the new accuracy with this

The deadline for submissions is Monday April 13th through Canvas. **Note that this exercise is worth 10 points towards your overall grade.**
...
Data can be found here: https://drive.google.com/file/d/17kD3qfgeHVOg2t6OWbth082Yz1VqpwvL/view?usp=sharing

Original link to data: https://www.kaggle.com/datasets/apollo2506/landuse-scene-classification http://weegee.vision.ucmerced.edu/datasets/landuse.html
...
Data can be found here: https://drive.google.com/file/d/1sReimHhXsLhDpGuprzIUEs2IP9UxBAoi/view?usp=sharing

Original link to data https://www.kaggle.com/c/dogs-vs-cats/data
