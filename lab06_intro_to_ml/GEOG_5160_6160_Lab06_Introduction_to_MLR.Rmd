...
The RMSE is a good measure of the *average* error. It's worth noting here that this suggests our error is pretty large, around $95,000 dollars relative the actual price. 
...
4. Comment on whether you think this new model is better or worse at predictions than the mode you built in lab [1]
