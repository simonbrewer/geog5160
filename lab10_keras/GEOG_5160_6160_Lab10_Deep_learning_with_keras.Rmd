...
The plot suggests that, while there is no visible increase in the validation MAE, there is little improvement beyond about 70-80 epochs. Let's use this to train a final model on the full training dataset, and evaluate with the test set:
...
All the code to do this is in the two examples of this lab. You submitted answers shoud contain:
