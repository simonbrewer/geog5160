...
We'll now add a couple more packages, but first we'll create a new environment for class work (called `geog5160`)
...
Now we'll install the `pandas` package to help with data manipulation and the `matplot` package for making simple plots:
...
Both of these will ask you to install some supplementary packages; just press [y] to continue and install these. 
...
If you've got this far, we'll switch to the jupyter notebook for the remainder of this lab. If you haven't used these notebooks before, it's probably worth spending a little time working a new one at some point to get used to navigating through them. 
